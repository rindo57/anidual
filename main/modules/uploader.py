...
async def upload_video(msg: Message,file,id,tit,name,ttl):
    ...
    try:
        ...
        api_url = f"https://ouo.press/qs/jezWr0hG?s={long_url}"
        ...
        gotn_url = f"https://ouo.press/qs/jezWr0hG?s={directlink}"
        ...
        krtn_url = f"https://ouo.press/qs/jezWr0hG?s={krakenlink}"
