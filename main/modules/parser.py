...
def trim_title(title: str):
    ...
    title = title.replace(" - S02E", " Season 2 - ")
    title = title.replace(" - S03E", " Season 3 - ")
    title = title.replace(" - S04E", " Season 4 - ")
    title = title.replace(" - S05E", " Season 5 - ")
    title = title.replace(" - S06E", " Season 6 - ")
    title = title.replace(" - S07E", " Season 7 - ")
    title = title.replace(" - S08E", " Season 8 - ")
    title = title.replace(" - S09E", " Season 9 - ")
    title = title.replace(" - S10E", " Season 10 - ")
    title = title +".mkv"
    return title
